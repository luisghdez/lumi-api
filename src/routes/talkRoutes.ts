...
import { assessContinuousTalkTurnController, assessTalkAttemptController, createTalkSessionController, createTalkWebRtcOfferController } from "../controllers/talkController";
import { authenticateUser } from "../middleware/authUser";

export default async function talkRoutes(fastify: FastifyInstance) {
  fastify.post("/talk/attempts/:attemptId/turns", { preHandler: authenticateUser }, assessContinuousTalkTurnController);
